...
>(({ className, ...props }, ref) => (
  <ol
    ref={ref}
    className={cn(
      "flex flex-wrap items-center gap-0 break-words text-sm text-slate-500 sm:gap-0 dark:text-slate-400",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <li
    ref={ref}
    className={cn("inline-flex items-center p-2 justify-center", className)}
    {...props}
  />
))
